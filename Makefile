...
ifeq ($(ARCH),pip)
  CFLAGS+= -DPIP -m32 -nostdlib --freestanding -fno-builtin -fno-zero-initialized-in-bss
  #MOD_OBJ+=$(LIBBASE)modules/pico_dev_galileo.o
  MOD_OBJ+=$(LIBBASE)modules/pico_dev_slip.o
endif
